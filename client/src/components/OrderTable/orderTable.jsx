...
// import { deleteCategory, searchCategory } from "./../../redux/actions/category_actions";
...
//         (state) => state.orderReducer.order.list.orders
//     );
...
//                             </td>
//                             <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
//                                 <button class="h-10 px-5 m-2 text-blue-100 transition-colors duration-150 bg-blue-600 rounded-lg focus:shadow-outline hover:bg-blue-700"> <Link to={'/orders/edit/' + c._id}>✍</Link> </button>
