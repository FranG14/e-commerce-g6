            ...
            <section class="text-gray-700 body-font overflow-hidden bg-gray-200">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap bg-gray-100 pr-5 rounded-2xl">
                        <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={`https://e-commerce-g6-back.herokuapp.com/products/${productsArray.img}`}></img>
